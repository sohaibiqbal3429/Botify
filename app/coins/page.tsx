...
const ECONOMICS_RULES = [
  {
    ...
    value: "$80+",
    scheduled: "Fund your wallet now to auto-qualify when rewards open.",
    live: "Deposits of $80 or more stay rewards-eligible.",
  },
  {
  ...
  },
  {
    label: "Daily Yield",
    value: "Default 1.5%",
    scheduled: "Projected daily return once rewards begin.",
