        ...
        <div className="space-y-5 px-4 py-4 sm:px-5 sm:py-5">
          ...
          <Card className="gap-5 py-5">
            <CardHeader className="px-5 pb-3">
              ...
              <CardDescription>Adjust the platform-wide daily payout percentage.</CardDescription>
            </CardHeader>
            <CardContent className="px-5 pb-5">
          ...
          <Card className="gap-5 py-5">
            <CardHeader className="px-5 pb-3">
              ...
              <CardDescription>
                Optional override for daily team rewards. Leave empty to use level defaults (L1: 1%, L2: 1%, L3-5: 2%).
              </CardDescription>
            </CardHeader>
            <CardContent className="px-5 pb-5">
